...
description: "A legacy transportation-system migration organized around explicit capability mapping, domain closure, idempotency, and runtime verification."
---
...
The migration began with a capability matrix and then moved through domain closures. Every old entry had to be classified as migrated, merged, replaced, or deliberately dropped, with a new route, API, state machine, and acceptance scenario. An unclassified page could not be counted as complete.
...
## One contract for web, PWA, and Android
...
Automated gates covered the full backend test suite, open-source boundary checks, frontend type checking and production builds, mobile tests, Capacitor synchronization, and Android APK assembly.
